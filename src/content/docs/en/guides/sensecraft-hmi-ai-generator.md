...
- Click the AI button on the right, and then select **AI Image Generator**or **AI Layout Generator** according to your actual needs.
...
:::tip
The default preview color is Black and White. Click on Dither Mode and select Six Colors to display colors.
:::
